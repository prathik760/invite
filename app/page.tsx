...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/95 backdrop-blur-xl relative">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
          ...
          >
            ...
            <img src="/logo.png" alt="" className="h-9 w-9" aria-hidden="true" />
      ...
      {/* ─── FOOTER ─── */}
      <footer className="border-t border-border bg-[#EFE5D8] px-5 py-14">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
            ...
            <nav className="flex flex-col gap-2.5" aria-label="Footer navigation">
              ...
              {[
                ...
                { href: '#templates', label: 'Templates', internal: false },

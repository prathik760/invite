      ...
      <div className="relative">
        ...
        >
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.55)' }}>
            &ldquo;The gold design matched our theme perfectly. Guests loved it.&rdquo;
          </p>
...
export default function SignupPage() {
  ...
  const pwColors = ['', '#B96B70', '#D9A441', '#2F766D']
    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-7">
              <h1 className="font-display text-3xl text-ink mb-1.5 font-normal">Create your account</h1>
              <p className="text-sm text-muted leading-relaxed">
                Start creating and managing beautiful invitations for free.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold uppercase tracking-[0.18em] mb-1.5" style={{ color: '#7E716B' }}>
                  Your Name <span className="normal-case tracking-normal text-muted/55 ml-1 font-normal">(optional)</span>
                </label>
                <input
                  type="text"
                  autoComplete="name"
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-[0.18em] mb-1.5" style={{ color: '#7E716B' }}>
                  Password <span style={{ color: '#B87924' }}>*</span>
                </label>
                <div className="relative">
                  <input
                    ...
                    <div className="flex gap-1 flex-1">
                      {[1, 2, 3].map(i => (
                        <div key={i} className="h-1 flex-1 rounded-full transition-all duration-300"
                          style={{ background: i <= pwStrength ? pwColors[pwStrength] : '#E8DCCD' }} />
                      ))}
                    </div>
                    <span className="text-xs font-medium transition-colors" style={{ color: pwColors[pwStrength] }}>
                      {pwLabels[pwStrength]}
                    </span>
                  </div>
                )}
          ...
          <p className="text-center mt-6 text-sm text-muted">
            ...
            <Link href="/auth/login" className="font-semibold hover:opacity-70 transition-opacity" style={{ color: '#B87924' }}>
              Sign in →
            </Link>
          </p>
        </motion.div>

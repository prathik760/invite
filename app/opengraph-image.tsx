...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ fontSize: 28, color: '#B87924', letterSpacing: 4, textTransform: 'uppercase' }}>
          ShareInvite
        </div>
        <div style={{ marginTop: 26, maxWidth: 880, fontSize: 76, lineHeight: 1.04 }}>
          Digital Invitation Maker for Indian Events
        </div>
        <div style={{ marginTop: 28, maxWidth: 820, fontSize: 30, lineHeight: 1.35, color: '#7E716B' }}>
          Wedding invitations, WhatsApp invite pages, RSVP tracking, venue maps, gallery, music, and guest wishes.
        </div>
        <div style={{ marginTop: 44, display: 'flex', gap: 18, fontSize: 24, color: '#2F766D' }}>
